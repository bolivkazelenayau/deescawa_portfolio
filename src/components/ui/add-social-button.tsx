...
import { Button } from "./header_nav/button";
import { cn } from "@/lib/utils";
import { useState } from "react";
import { LucideAtSign, Instagram, Link } from "lucide-react";
...
export default function SocialButton({
    ...
    const shareButtons = [
        { icon: LucideAtSign, label: "Share on Twitter" },
        { icon: Instagram, label: "Share on Instagram" },
        { icon: FaTelegram, label: "Share on LinkedIn" },
        { icon: Link, label: "Copy link" },
    ];

    const expandedWidth = shareButtons.length * 40;
    ...
    return (
        ...
        >
            ...
            {/* Социальные кнопки - используем transform вместо width */}
            <div
